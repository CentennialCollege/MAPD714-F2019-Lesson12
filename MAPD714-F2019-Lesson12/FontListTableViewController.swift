...
class FontListTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if(showsFavourites)
        {
            fontNames = FavouritesList.getInstance().favourites
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FontListTableViewController.cellIdentifier, for: indexPath)
